...
while not((DesiredPoint ==CurrentLocation)[0] and (DesiredPoint ==CurrentLocation)[1]):
    ...
    if  Position0[0] != 0  and Position0[1] != 0 and Position0[0]-1 < len(myArray) and Position0[0] -1< len(myArray[1]) and myArray[Position0[0]][Position0[1]] != "|"  and myArray[Position0[0]][Position0[1]] != "_" : 
        A = str(Position0[0])+"-"+str(Position0[1])
        if A not in visited:
            if A not in queue:
                queue.append(A)
    if  Position1[0] != 0  and Position1[1] != 0 and Position1[0]-1 < len(myArray)-1 and Position1[0]-1 < len(myArray[1])  and myArray[Position1[0]][Position1[1]]  != "_" and myArray[Position1[0]][Position1[1]]  != "|":
        B = str(Position1[0])+"-"+str(Position1[1])
        if B not in visited:
            if B not in queue:
                queue.append(B)
    if  Position2[0] != 0  and Position2[1] != 0 and Position2[0]-1 < len(myArray)-1 and Position2[0]-1 < len(myArray[1]) and myArray[Position2[0]][Position2[1]] != "|" and   myArray[Position2[0]][Position2[1]] != "_" :
        C = str(Position2[0])+"-"+str(Position2[1])
        if C not in visited:
            if C not in queue:
                queue.append(C)
    if  Position3[0] != 0  and Position3[1] != 0 and Position3[0]-1 < len(myArray)-1 and Position3[0] -1< len(myArray[1])  and myArray[Position3[0]][Position3[1]]  != "_" and myArray[Position3[0]][Position3[1]]  != "|" :
        D = str(Position3[0])+"-"+str(Position3[1])
        if D not in visited:
            if D not in queue:
                queue.append(D)
